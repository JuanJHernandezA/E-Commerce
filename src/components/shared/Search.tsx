...
const Search = () => {
  ...
  return (
    ...
    <div className="py-5 px-7 flex gap-10 items-center border-b border-slate-200">
      <form action="" className='flex gap-3 items-center flex-1' onChange={handleSearch}>
        <HiOutlineSearch size={22} />
        <input type='text' placeholder='¿Qué busa?' className='outline-none w-full text-sm' value={searchTerm} onChange={e=> setSearchTerm(e.target.value)} />
      </form>
