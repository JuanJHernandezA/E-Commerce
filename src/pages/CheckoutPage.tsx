  ...
  return (
    <div style={{
        ...
        border-slate-200 '>
            ...
            <Link to='/' className='text-4xl font-bold self-center trancking-tighter transition-all md:text-5xl md:self-start'>
            <p>
                Tech 
        ...
        <main className="w-full h-full flex relative">
            {
                totalItems === 0?(
                    ...
                    <div className='bg-stone-100 w-1/2 sticky top-0 right-0 p-10 hidden md:block' style={{minHeight:'calc(100vh - 100px)'}}>
                            <ItemsCheckout />
                    </div>
                    </>
                )
