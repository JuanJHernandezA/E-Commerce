    ...
    <div className="flex flex-col h-screen">
      ...
      <main className="container mx-auto flex-1 flex flex-col items-center gap-10">
        ...
        <div className="border border-slate-200 w-full md:w-[600px] p-5 rounded-md space-y-3">
          ...
          <p className="text-sm">
            Gracias por realizar tu compra en TechFull. Para realizar la
          ...
          <p className="text-sm">
            Una vez confirmada la transferencia, hacemos entrega de tu orden.
          </p>
        </div>
        ...
        <div className="border border-slate-200 w-full p-5 rounded-md space-y-3 md:w-[600px]">
          ...
          <div className="grid grid-cols-2 gap-5">
            ...
            <div className="flex flex-col text-sm">
              ...
              <p>Departamento: {data.address.state}</p>
              <p>{data.address.postalCode && (<>Código postal: </>)}{data.address.postalCode}</p>
