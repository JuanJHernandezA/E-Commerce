  ...
  return (
    <div>
      <div className="flex flex-col justify-between items-center gap-5 md:flex-row md:gap-0">
        <button
          className="border rounded-full py-2 border-slate-200 px-5 flex items-center justify-center 
          ...
          <tbody>
            {order.orderItems.map((product, index) => (
              <tr key={index} className="border-b border-gray-200">
                ...
                <td className="p-4 font-medium tracking-tighter  gap-3 text-center">
                  {product.quantity}
                </td>
                <td className="p-4 font-medium tracking-tighter  gap-3 text-center">
