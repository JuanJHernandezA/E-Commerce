...
export const CellPhonePage = () => {
  ...
  <div className="h-fit flex flex-col md:flex-row gap-16 mt-8">
    ...
    <div className="flex-1 space-y-5">
        <h1 className="flex-3xl font-bold tracking-tight">
            {product.name}
        </h1>
            ...
            <div className="flex gap-3">
                {
                    availableColors.map(color=>(
                        <button key={color} className={`w-8 h-8 rounded-full flex justify-center cursor-pointer items-center ${selectedColor ===color ? 'border border-slaet-800' : ''}`}
        ...
        <div className="flex flex-col gap-3">
            ...
            </p>
            {
                selectedColor && (
                    <div className="flex gap-3">
                <select name="" id="" className='border border-gray-300 rounded-lg px-3 py-1' value={selectedStorage || ''} onChange={e => setSelectedStorage(e.target.value)}>
                    {
        ...
        {
            isOutOfStock ? (
                <button disabled className='bg-[#F3F3F3] uppercase font-semibold tracking-widest text-xs py-4 rounded-full transition-all duration-300 hover:bg-[#e2e2e2]
                w-full'>Agotado</button>
            ) :(
                <>
        ...
        <div className="flex pt-2">
            ...
            <Link to={'#'} className='flex flex-col gap-1 flex-1 items-center justify-center'>
                ...
                <p className='flex lfex-col items-center text-xs'>
